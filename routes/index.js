...
router.post('/choice', function(req, res, next){
  ...
  res.render('miser', {user: req.session.user, dataGame, gameSelected, friendSelected, dataFriend: dataFriend});
});

// Routes pour les mises vers le panier
router.post('/mise5', function (req, res, next){
  montant = req.body.cinq;
  res.render('panier', {user: req.session.user, dataFriend: dataFriend, gameSelected: req.body.game, friendSelected: req.body.friend, montant: montant});
});
...
router.post('/paiement', function (req, res, next){
  res.render('attente', {user: req.session.user, dataFriend: dataFriend, gameSelected: req.body.game, friendSelected: req.body.friend, montant: montant});
});
...
router.post('/partie', function(req, res, next){
  res.render('envoiphoto', {dataGame: dataGame, dataFriend: dataFriend, gameSelected: req.body.game, user: req.session.user, friendSelected: req.body.friend, montant: montant});
});
